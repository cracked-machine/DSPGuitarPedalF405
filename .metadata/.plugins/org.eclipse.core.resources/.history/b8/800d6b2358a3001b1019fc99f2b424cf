...
IIRFilterFx::IIRFilterFx()
{
	...
	void IIRFilterFx::process_half_u16(	AudioBlockU16< FULL_BLK_SIZE_U16 > *pRxBuf,
	...
	void IIRFilterFx::process_full_u16(	AudioBlockU16< FULL_BLK_SIZE_U16 > *pRxBuf,
										AudioBlockU16< FULL_BLK_SIZE_U16 > *pTxBuf)
	{
		if(pRxBuf == nullptr || pTxBuf == nullptr)
			error_handler();
		...
		offset_write_ptr = IIRFilterFx::MONO_CH_SIZE_F32;
		write_ptr = IIRFilterFx::MONO_CH_SIZE_F32;

		process_all_u16(pRxBuf, pTxBuf);
	}

	void IIRFilterFx::process_all_u16(	AudioBlockU16< FULL_BLK_SIZE_U16 > *pRxBuf,
										AudioBlockU16< FULL_BLK_SIZE_U16 > *pTxBuf)
	{
		if(pRxBuf == nullptr || pTxBuf == nullptr)
			error_handler();
		  ...
		  for (size_t i = offset_read_ptr; i  <offset_read_ptr + STEREO_CH_SIZE_U16; i = i + 4) {
...
#ifndef ENABLE_CPPUTEST
		  //process IIR
		  arm_biquad_cascade_df1_f32 (&left_iir_settings, &left_buf_in[offset_write_ptr], &left_buf_out[offset_write_ptr], IIRFilterFx::MONO_CH_SIZE_F32);
		  arm_biquad_cascade_df1_f32 (&right_iir_settings, &right_buf_in[offset_write_ptr], &right_buf_out[offset_write_ptr], IIRFilterFx::MONO_CH_SIZE_F32);
#endif
